...
1. 在你的 vimrc 文件中添加如下内容：
   ...
   ```
   Plugin 'wuaifx/vim-markdown-toc'
   ```
...
[使用本插件生成 TOC 的英文文档在线示例](https://github.com/wuaifx/chinese-copywriting-guidelines/blob/Simplified/README.en.md)

![](https://github.com/wuaifx/vim-markdown-toc/raw/master/screenshots/english.gif)

[使用本插件生成 TOC 的中文文档在线示例](https://wuaifx.ga/wiki/chinese-copywriting-guidelines/)

![](https://github.com/wuaifx/vim-markdown-toc/raw/master/screenshots/chinese.gif)

## 参考链接

* [GFM 与 Redcarpet 的不同点](https://wuaifx.ga/2015/12/05/diff-between-gfm-and-redcarpet/)
