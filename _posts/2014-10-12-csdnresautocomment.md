...
GitHub 仓库地址：<https://github.com/wuaifx/csdncommenter>
...
遂在 GitHub 上建了个仓库开工，地址在这里：<https://github.com/wuaifx/csdncommenter>。
...
（GitHub 仓库：[wuaifx/csdncommenter](https://github.com/wuaifx/csdncommenter)，现在可以通过 pip 安装使用了  `pip install csdncommenter`  然后  `csdncommenter`。2015/10/27 update）

```python
# File   : csdncommenter.py
# Author : Zhuang Ma
# E-mail : chumpma(at)gmail.com
# Website: https://wuaifx.ga
# Date   : 2016-07-26
import requests
