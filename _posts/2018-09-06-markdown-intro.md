...
<https://github.com/wuaifx/markdown-intro>
...
```
行内式 [博客](https://wuaifx.ga "我的个人博客") 链接，带 title。

行内式 [GitHub](https://github.com/wuaifx) 链接。
...
[1]: https://wuaifx.ga
[2]: https://github.com/wuaifx "我的 GitHub 主页"
```
...
```html
<p>行内式 <a href="https://wuaifx.ga" title="我的个人博客">博客</a> 链接，带 title。</p>

<p>行内式 <a href="https://github.com/wuaifx">GitHub</a> 链接。</p>

<p>引用式 <a href="https://wuaifx.ga">博客</a> 链接。</p>

<p>引用式 <a href="https://github.com/wuaifx" title="我的 GitHub 主页">GitHub</a> 链接，带 title。</p>
```
...
```
![Alt text](https://wuaifx.ga/favicon.ico "favicon")
```
...
```html
<img src="https://wuaifx.ga/favicon.ico" alt="Alt text" title="favicon">
```
...
![task list 1](https://raw.githubusercontent.com/wuaifx/markdown-intro/master/assets/task-list-1.png)

还可以直接在网页上拖动调整顺序，勾选和取消勾选。

![task list 2](https://raw.githubusercontent.com/wuaifx/markdown-intro/master/assets/task-list-2.png)
...
![流程图](https://raw.githubusercontent.com/wuaifx/markdown-intro/master/assets/tapd-markdown-flowchart.png)

![时序图](https://raw.githubusercontent.com/wuaifx/markdown-intro/master/assets/tapd-markdown-seq.png)

### 插入数学公式

仍然以 TAPD 为例：

![数学公式](https://raw.githubusercontent.com/wuaifx/markdown-intro/master/assets/tapd-markdown-math.png)
...
我维护的工具地址：<https://md.wuaifx.ga>

![微信公众号](https://raw.githubusercontent.com/wuaifx/markdown-intro/master/assets/wechat-markdown.png)
...
另外可以参考我以前的一篇博客 [关于 Markdown 的一些奇技淫巧](https://wuaifx/2017/09/01/markdown-odd-skills/)。
...
* [关于 Markdown 的一些奇技淫巧](https://wuaifx.ga/2017/09/01/markdown-odd-skills/)
