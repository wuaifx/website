...
1. 在你的 vimrc 文件中添加如下内容：
   ...
   ```markdown
   Plugin 'wuaifx/vim-kramdown-tab'
   ```
...
[1]: https://wuaifx.ga/2016/02/04/switch-to-kramdown-from-redcarpet/
[2]: https://github.com/wuaifx/vim-kramdown-tab
[3]: http://github.com/VundleVim/Vundle.Vim
[4]: https://raw.githubusercontent.com/wuaifx/vim-kramdown-tab/master/screenshots/test.gif
